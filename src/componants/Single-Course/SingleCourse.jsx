const SingleCourse = (course) => {
    ...
    return (
        <div className="w-[312px] bg-white p-4 rounded-xl flex flex-col gap-4">
            ...
            <p className="text-[#1c1b1b99]">{course.course.short_description}</p>
            <div className="flex gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <p>Credit : {course.course.course_duration}hr</p>
                </div>
            </div>
            <div className="flex">
                    <button className="bg-[#2F80ED] flex-1 text-white py-2 rounded-lg mt-2">Select</button>
            </div>
